  ...
  return (
    <div className="max-w-3xl space-y-6" data-testid="page-settings">
      ...
      <section className="bg-[#161b22] border border-[#30363d] rounded-lg overflow-hidden">
        ...
        <Row icon={Cpu} label="Уеб търсене" value="Gemini 3 Pro + Google Search" testid="cfg-search" />
      ...
      <section className="bg-[#161b22] border border-[#30363d] rounded-lg p-6">
        ...
        <p className="text-[#8b949e] text-sm leading-relaxed">
          RealCheck използва двуетапен AI пайплайн с <span className="text-[#3fb950] font-medium">Gemini 3 Pro</span>: първо моделът използва <span className="text-[#58a6ff] font-medium">Google Search</span> grounding инструмент, за да намери актуални факти и източници в мрежата, след което в отделна стъпка оценява всяко
          ...
          <span className="text-[#f85149] font-medium">непотвърдено</span>, базирано на намерените източници. Общият рейтинг
